...
import { SCHEDULED_CONVERSATIONS } from "./scheduledRuns";
...
export function allAgentInstances(): AgentInstance[] {
  return dedupeByRef(
    [...mockAgentInstances, ...SCHEDULED_CONVERSATIONS.map(({ id, name }): AgentInstance => ({
      id, contextId: id, name, creator: "scheduled-run", harness: "kagent/k8s-agent", agentTemplate: "kagent/k8s-agent-7f3a91c", state: "ready", operation: "unspecified", createdAt: "2026-09-07T09:00:00Z", updatedAt: "2026-09-07T09:00:05Z", labels: {}, scheduledRun: true,
